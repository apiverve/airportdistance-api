...
class TestAirportdistanceAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = AirportdistanceAPIClient(self.api_key)

    @patch('apiverve_airportdistance.apiClient.requests.get')
