/*
 * Airport Distance API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Airport Distance API.
 * API Documentation: https://docs.apiverve.com/ref/airportdistance
 */
...
{
    class AirportDistanceExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/airportdistance";

        /// <summary>
        /// Make a GET request to the Airport Distance API
        /// </summary>
        static async Task<JsonDocument> CallAirportDistanceAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;iata1&quot;] &#x3D; &quot;JFK&quot;, [&quot;iata2&quot;] &#x3D; &quot;LAX&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Airport Distance API...\n");

            var result = await CallAirportDistanceAPI();
