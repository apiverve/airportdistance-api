...
namespace APIVerve\Airportdistance;
...
/**
 * Client for the Airport Distance API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://airportdistance.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/airportdistance';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\AirportdistanceClient] {$message}\n";
        }
    }
}
