...
namespace APIVerve.API.AirportDistance
{
    ...
    /// <summary>
    /// Client for the AirportDistance API
    /// </summary>
...
#endif
    {
        ...
        {
            { "iata1", new ValidationRule { Type = "string", Required = true } },
            { "iata2", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        private void ValidateParams(AirportDistanceQueryOptions options)
        {
