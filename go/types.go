// Package airportdistance provides a Go client for the Airport Distance API.
//
// For more information, visit: https://airportdistance.apiverve.com?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Airport Distance API.
//
// Parameters:
//   - iata1 (required): string - The IATA code of the first airport (e.g. JFK)
//   - iata2 (required): string - The IATA code of the second airport (e.g. LAX)
type Request struct {
	Iata1 string `json:"iata1"` // Required
	Iata2 string `json:"iata2"` // Required
}
...
// ResponseData contains the data returned by the Airport Distance API.
type ResponseData struct {
	DistanceMiles float64 `json:"distanceMiles"`
	DistanceKm float64 `json:"distanceKm"`
	Airport1 Airport1Data `json:"airport1"`
	Airport2 Airport2Data `json:"airport2"`
}

// Airport1Data represents the airport1 object.
type Airport1Data struct {
...
// Airport2Data represents the airport2 object.
type Airport2Data struct {
	Name string `json:"name"`
	Iata string `json:"iata"`
	Icao string `json:"icao"`
	City string `json:"city"`
